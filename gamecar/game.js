    ...
    function moveEnemy(car) {
        ...
        enemy.forEach(function (item) {
            if (isCollide(car, item)) {
                ...
                endGame();
                endSong();
                startScreen.innerHTML = "Game over Eres una CHINGA mirá tu puntaje :" + player.score + "<br>" + " Probá de nuevo o envía un mensaje con la captura de tu logro a " + "<a href='mailto:djcarloshermida@outlook.com'>DJCarlosHermida</a>";
            }
